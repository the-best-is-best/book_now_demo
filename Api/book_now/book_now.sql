...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2022 at 01:40 PM
...
--
-- Constraints for table `rel_people`
--
ALTER TABLE `rel_people`
  ADD CONSTRAINT `rel_people_ibfk_1` FOREIGN KEY (`house_id`) REFERENCES `houses` (`id`),
  ADD CONSTRAINT `rel_people_ibfk_2` FOREIGN KEY (`people_id`) REFERENCES `people` (`id`),
  ADD CONSTRAINT `rel_people_ibfk_3` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`),
  ADD CONSTRAINT `rel_people_ibfk_4` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`),
  ADD CONSTRAINT `rel_people_ibfk_5` FOREIGN KEY (`travel_id`) REFERENCES `travel` (`id`);
COMMIT;
